...
\begin{document}
	...
	\par \begin{enumerate}[topsep=1px]
		...
		\switchenum
		\item Ik noem driehoekige krommen, deze uit drie bogen $AB, AC$ en $BC$ naar binnen gebogen, die in de hoeken $A$, $B$ en $C$ samenkomen en die ook geen andere vertakkingen bevatten. Deze krommen van deze aard om ononderbroken te zijn, kunnen uitgedrukt worden volgens zekere vergelijking, hetzij algebraïsch, of zelfs transcendent, het is essentieel, dat ze in de hoeken $A$, $B$ en $C$ scherpe spitsen hebben, waar de twee bogen samenkomen bevatten ze een gemeenschappelijke raaklijn. Er kunnen ontelbare zulke krommen gemaakt worden, zowel algebraïsch als transcendent, een lange tijd geleden heb ik aangetoond dat problemen van de soorten krommen, die een bepaald brandpunt omschrijven, te verklaren, waarbij elke straal tweemaal terugkaatst in de kromme en terugkeert naar hetzelfde brandpunt, voor het welke probleem meerdere oplossingen in Actis Lipsiensibus gedateerd 1746 en 1748 gevonden werden. Hier worden deze oplossingen herleid tot het vinden van driehoekige krommen, immers worden deze gevormd als caustiek door deze teruggekaatste stralen.
		...
		\begin{figure}[h]
			...
			\par {
				...
				\begin{tikzpicture}[rotate=180, scale=1, font=\scriptsize]
				\draw [shift={(-1.651,-2.108)}]  plot[domain=0.141:0.906,variable=\t]({2.678*cos(\t r)},{2.678*sin(\t r)});
				\draw [shift={(1,2.484)}]  plot[domain=4.330:5.095,variable=\t]({2.678*cos(\t r)},{2.678*sin(\t r)});
				\draw [shift={(3.651,-2.108)}]  plot[domain=2.235:3.001,variable=\t]({2.678*cos(\t r)},{2.678*sin(\t r)});
				\draw (0,0) node [below right] {$C$};
				\draw (2,0) node [below left] {$B$};
				\draw (1,-1.732) node [above] {$A$};
				\end{tikzpicture}}
		...
		\begin{figure}[h]
			...
			\par {
				...
				\draw (0,0) node [below left, yshift=4pt, xshift=2pt] {$A$};
				\draw (2,0) node [above] {$C$};
				\draw (1,-1.732) node [below right, yshift=5pt] {$B$};
				\draw (1,1.135) node [above] {$g$};
				\draw (2.483,0.279) node [above right, xshift=-5pt] {$H$};
				\draw (2.483,-1.434) node [below right, yshift=4pt] {$f$};
				\draw (-0.483,0.279) node [above left, yshift=-3pt, xshift=1pt] {$F$};
				\draw (-0.483,-1.434) node [below left] {$h$};
				\draw (1,-2.290) node [below] {$G$};
				\draw (1.563,-0.134) node [above] {$S$};
				\draw (2.579,0.085) node [right] {$X$};
				\draw (-0.712,-0.623) node [left] {$x$};
				\end{tikzpicture}}
			\fontfamily{cmr}\selectfont
			\caption{Tab. I. Fig. 2.}
		\end{figure}
		...
		\begin{figure}[h]
			...
			\par {
				\fontfamily{jkplvos}\selectfont
				\begin{tikzpicture}[scale=1.4, font=\scriptsize]
				\draw [shift={(-1.651,-2.108)}]  plot[domain=0.141:0.906,variable=\t]({2.678*cos(\t r)},{2.678*sin(\t r)});
				\draw [shift={(1,2.484)}]  plot[domain=4.330:5.095,variable=\t]({2.678*cos(\t r)},{2.678*sin(\t r)});
				\draw [shift={(3.651,-2.108)}]  plot[domain=2.235:3.001,variable=\t]({2.678*cos(\t r)},{2.678*sin(\t r)});
				
				\draw (1,-0.194) -- (1.332,-0.769) -- (0.668,-0.769) -- cycle;
				\draw (0,0) -- (1.332,-0.769);
				\draw (2,0) -- (0.668,-0.762);
				
				\draw (0,0) node [above left, xshift=2pt, yshift=-2pt] {$A$};
				\draw (2,0) node [above right, xshift=-2pt, yshift=-2pt] {$C$};
				\draw (1,-1.732) node [below] {$B$};
				\draw (1,-0.194) node [above] {$g$};
				\draw (1.332,-0.769) node [below right, yshift=2pt] {$f$};
				\draw (0.668,-0.762) node [below left, yshift=2pt] {$h$};
				\end{tikzpicture}}
			\fontfamily{cmr}\selectfont
			\caption{Tab. I. Fig. 3.}
		\end{figure}
		...
		\begin{figure}[h]
			...
			\par {
				...
				\draw (0,2) node [above] {$X$};
				\draw (0,-2) node [below] {$x$};
				\draw (-1.362,0.674) node [left, xshift=2pt] {$L$};
				\draw (-0.680,-0.662) node [below left, xshift=2pt, yshift=2pt] {$o$};
				\draw (-0.680,1.337) node [above left, xshift=2pt, yshift=-2pt] {$O$};
				\draw (0,0.637) node [right, xshift=-2pt] {$Z$};
				\draw (0,-0.316) node [right, xshift=-2pt] {$z$};
				\draw (-2.,0.) node [below left] {$F$};
				\draw (2.,0.) node [below right] {$G$};
				\end{tikzpicture}}
			\fontfamily{cmr}\selectfont
			\caption{Tab. I. Fig. 4.}
		\end{figure}
		...
		\begin{figure}[h]
			...
			\par {
				...
				\draw (-1.0192,1.720) node [above] {$M$};
				\draw (-2.,0.) node [left] {$F$};
				\draw (2.,0.) node [right] {$f$};
				\draw (-1.0193,0.) node [below left] {$P$};
				\draw (1.267,-1.547) node [below right] {$m$};
				\draw (0.184,0.) node [below left] {$N$};
				\draw (1.267,0.) node [above] {$p$};
				\draw (-1.019,-1.547) node [above right] {$S$};
				\end{tikzpicture}}
			\fontfamily{cmr}\selectfont
			\caption{Tab. I. Fig. 5.}
		\end{figure}
		...
		\par Benoem nu de hoek $FNM = \phi$, zodat $\tan \phi = \frac{1}{p}$, zodat $p = \cot \phi = \frac{\cos \phi}{\sin \phi}$, en dit resulteert in
		\[
			\sin \phi = \frac{1}{\sqrt{1+p^2}} \quad \text{et} \quad \cos \phi = \frac{p}{\sqrt{1+p^2}}
		\]
		\par dan geldt ook $\D \phi = -\frac{\D p}{1+p^2}$. Stel nu voor het gemak de afkorting $FN=v$, het is geweten dat het centrum van de osculatiecirkel in $M$, in het punt $U$ is, dan is het zo
		\[
			NU = \frac{\D v \cdot \sin \phi}{\D \phi};
		\]
		\par Maar als, het element $\D p$ constant genomen wordt, is
		\begin{align*}
			\D  v &= \frac{\D^2  S}{\D p}(1+p^2)+p\,\D S-S\,\D p \quad \text{en}\\
			\frac{\sin \phi}{\D \phi} &= -\frac{\sqrt{1+p^2}}{\D p}
		\end{align*}
		\par en de lijn zal zijn
		\[
			NU = -\frac{\D^2 S}{\D p^2} (1+p^2)^{\frac{3}{2}}-\frac{p\,\D S}{\D p} \sqrt{1+p^2} + S\sqrt{1+p^2}
		\]
		...
		\begin{figure}[h]
			...
			\par {
				\fontfamily{jkplvos}\selectfont
				\begin{tikzpicture}[scale=0.8, font=\scriptsize]
				\draw (124.740:0.763) arc (124.740:180:0.763);
				\draw (0,0) circle (2cm);
				\draw (-1.140,1.643)-- (1.140,-1.643);
				\draw (1.050,-1.514)-- (1.050,0);
				\draw (-1.140,0)-- (-1.140,1.644);
				\draw (-2,0)-- (2,0);
				
				\draw (0,0) node [below left] {$N$};
				\draw (-2,0) node [left] {$F$};
				\draw (2,0) node [right] {$f$};
				\draw (-1.140,1.643) node [above] {$M$};
				\draw (1.140,-1.643) node [below right] {$m$};
				\draw (-1.140,0) node [below] {$P$};
				\draw (1.050,-1.514) node [below left,yshift=3pt] {$U$};
				\draw (1.0450,0) node [above] {$T$};
				\draw (-0.4,0.2) node {$\phi$};
				\end{tikzpicture}}
			\fontfamily{cmr}\selectfont
			\caption{Tab. I. Fig. 6.}
		\end{figure}
		...
		\begin{figure}[h]
			...
			\par {
				...
				\draw [shift={(2.028,0)}] plot[domain=2.09:4.189,variable=\t]({1.81*cos(\t r)},{1.81*sin(\t r)});
				\draw [shift={(-2.82,4.994)}]  plot[domain=4.954:5.517,variable=\t]({5.145*cos(\t r)},{5.145*sin(\t r)});
				\draw [shift={(-2.83,-4.99)}]  plot[domain=4.954:5.517,variable=\t]({5.14*cos(\t r)},{-5.145*sin(\t r)});
				\draw (-1.593,0)-- (1.124,0);
				\draw (0.880,1.427) -- (0.880,0);
				\draw (1.123,1.568) node [above right] {$B$};
				\draw (1.123,-1.568) node [below right] {$C$};
				\draw (-1.592,0) node [left] {$D$};
				\draw (1.123,0) node [right] {$E$};
				\draw (0.217,0) node [below left] {$A$};
				\draw (0.880,1.427) node [above] {$M$};
				\draw (0.880,0) node [below] {$F$};
				\end{tikzpicture}}
			\fontfamily{cmr}\selectfont
			\caption{Tab. I. Fig. 7.}
		\end{figure}
		...
		\begin{align*}
			t & = \frac{\D S}{\D p}-\frac{p\,\D^2 S}{\D p^2}(1+p^2)\quad\text{en}\\
			u & = S-\frac{p\,\D S}{\D p}-\frac{\D^2 S}{\D p^2}(1+p^2)
		\end{align*}
		\par merk nu allereerst op dat de rechte $NU$ rakend is aan de kromme in $U$, die aangezien de hellingshoek met de as $TNU=\phi$ is, die cotangens $p$ heeft, dan is het noodzakelijk dat $\frac{\D u}{\D t} = \tan \phi = \frac{1}{p}$, en dus $\D t = p \, \D u$. Dit volgt ook uit de formules 

		\begin{align*}
			\D t &= -\frac{3p^2\, \D^2 S}{\D p}-\frac{p(1+p^2)\, \D^3S}{\D p^2} \quad \text{en}\\
			p\, \D u &= - \frac{3p^2 \, \D^2 S}{\D p} - \frac{p(1+p^2)\, \D^3S}{\D p^2}.
		\end{align*}
		\par Zodat werkelijk $\D t=p\, \D u$.
		\switchcolumn*
		...
		\switchenum
		\item Omdat het zo is dat $\D t=p\, \D u$, de gevallen waarbij het zo is dat $\frac{\D t}{\D p}=0$, en het is dan ook zo dat $\frac{\D u}{\D p}= 0$; dan het is dus duidelijk dat, wanneer de abscis $t$ ofwel maximaal ofwel minimaal is, op dezelfde plaats de ordinaat ook maximaal ofwel minimaal zal zijn, wat de eigenschappen in de spitsen doet samenvallen. Van wat we verzamelen, zijn beide coördinaten {\color{red}$t$} en {\color{red}$q$} dus gelijktijdig ofwel maximaal ofwel minimaal, daar bestaan dan ook de spitsen van onze krommen; en gezien de kromme 3 spitsen hebben, moeten zowel $t$ als $u$ in 3 plaatsen maximaal zijn.
		...
		\begin{figure}[h]
			...
			\par {
				...
				\draw [shift={(4.236,2.446)}]  plot[domain=3.359:3.972,variable=\t]({3.314*cos(\t r)},{3.314*sin(\t r)});
				\draw [shift={(-2.627,2.671)}]  plot[domain=5.489:6.030,variable=\t]({3.747*cos(\t r)},{3.747*sin(\t r)});
				\draw [shift={(1,-3)}]  plot[domain=1.249:1.892,variable=\t]({3.163*cos(\t r)},{3.162*sin(\t r)});
				\draw (0,0)-- (0,0.331) -- (2,0.331) -- (2,0);
				\draw (1,1.732)-- (1,0.331);
				\draw (0,0) node [below] {$D$};
				\draw (2,0) node [below] {$C$};
				\draw (1,1.732) node [above] {$B$};
				\draw (0,0.331) node [above] {$H$};
				\draw (2,0.331) node [above] {$G$};
				\draw (1,0.331) node [below, yshift=2pt] {$F$};
				\end{tikzpicture}}
			\fontfamily{cmr}\selectfont
			\caption{Tab. I. Fig. 8.}
		\end{figure}
		...
		\begin{align*}
			...
			BC &= BD = \frac{3a \sqrt{9\alpha^2+3}}{8\alpha^3}
		\end{align*}
		\par hieruit is het duidelijk dat
		\[
			CD : BC = 2:\sqrt{3\alpha^2 + 1}
		\]
		...
		\begin{figure}[h]
			...
			\par {
				\fontfamily{jkplvos}\selectfont
				\begin{tikzpicture}[scale=0.8, font=\scriptsize]
				\draw (0,0)-- (3,0) -- (0,2) -- (0,-2) -- (3,0);
				\draw [shift={(-4.935,0)}]  plot[domain=-0.385:0.385,variable=\t]({5.325*cos(\t r)},{5.325*sin(\t r)});
				\draw [shift={(5,6.249)}]  plot[domain=3.846:4.403,variable=\t]({6.561*cos(\t r)},{6.561*sin(\t r)});
				\draw [shift={(4.968,-6.202)}]  plot[domain=1.878:2.440,variable=\t]({6.507*cos(\t r)},{6.507*sin(\t r)});
				\draw (0,0) node [left] {$G$};
				\draw (3,0) node [above] {$B$};
				\draw (3,0) node [below right] {$F$};
				\draw (0,2) node [above] {$D$};
				\draw (0,-2) node [below right] {$C$};
				\end{tikzpicture}}
			\fontfamily{cmr}\selectfont
			\caption{Tab. I. Fig. 9.}
		\end{figure}
		...
		\begin{figure}[h]
			...
			\par {
				\fontfamily{jkplvos}\selectfont
				\begin{tikzpicture}[font=\scriptsize]
				\draw (0,0)-- (3,0) -- (1.995,1.721) -- (0,-1.702) -- cycle;
				\draw (0,-1.702)-- (3,0);
				\draw [shift={(4.716,2.155)}]  plot[domain=3.3:4.04,variable=\t]({2.7556*cos(\t r)},{2.755*sin(\t r)});
				\draw [shift={(-5.201,3.623)}]  plot[domain=5.486:6.025,variable=\t]({7.444*cos(\t r)},{7.445*sin(\t r)});
				\draw [shift={(4.373,-5.915)}]  plot[domain=1.799:2.375,variable=\t]({6.072*cos(\t r)},{6.072*sin(\t r)});
				\draw (1.996,1.721)-- (1.996,0);
				\draw (0,0) node [above] {$G$};
				\draw (3,0) node [above right] {$A$};
				\draw (3,0) node [below right] {$F$};
				\draw (1.995,1.721) node [above] {$C$};
				\draw (0,-1.702) node [below] {$B$};
				\draw (1.995,0) node [below, yshift=2pt] {$H$};
				\draw (0.992,0) node [above left] {$O$};
				\end{tikzpicture}}
			\fontfamily{cmr}\selectfont
		...
		\begin{figure}[h]
			...
			\par {
				\fontfamily{jkplvos}\selectfont
				\begin{tikzpicture}[font=\scriptsize]
				\draw (0,0)-- (3,0) -- (3,2) -- (0,-1.702) -- cycle;
				\draw (0,-1.702)-- (3,0);
				\begin{scope}
					\clip (0,-2) rectangle (3,2.5);
					\draw [rotate around={-154.32:(5.82,2.033)}] (5.82,2.03) ellipse (3.68cm and 1.656cm);
				\end{scope}
				\draw (2.56,0) -- (2.56,0.34)-- (3,0.34);
				\draw (0,0) node [above] {$G$};
				\draw (3,0) node [below right] {$A$};
				\draw (3,2) node [above] {$C$};
				\draw (0,-1.702) node [below right] {$B$};
				\draw (2.559,0.339) node [left] {$M$};
				\draw (2.559,0) node [below, yshift=2pt] {$T$};
				\draw (3,0.338) node [right] {$S$};
				\end{tikzpicture}}
			\fontfamily{cmr}\selectfont
